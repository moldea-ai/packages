...
The package is available with one technical target covering TypeScript ESM using direct `models.generateContent` and `generateContentStream` calls with npm `@google/genai >=2.17.1`, Repository Format version `1`, and Core `^5.0.0`.
