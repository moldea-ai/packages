...
import { OPENAI_SDK_PACKAGE_NAME, OPENAI_SDK_SUPPORTED_RANGE } from '../constants/index.js';
import type { IOpenAiPackageDiscoveryResult } from '../contracts/index.js';
...
/**
 * Discovers the nearest relevant OpenAI package declaration without enumeration.
...
export const discoverOpenAiPackage = async (
  ...
  const result = await discoverPackage({
    packageName: OPENAI_SDK_PACKAGE_NAME,
    reader: {
    ...
    sourcePath,
    supportedRange: OPENAI_SDK_SUPPORTED_RANGE,
  });
