...
import { createVercelAiSdkDiagnostic } from '../diagnostics/index.js';
...
export const compareVercelAiSdkStrings = (left: string, right: string): number =>
  left < right ? -1 : left > right ? 1 : 0;

/** Determines whether a runtime-visible value satisfies Core's machine-string contract. */
export const isVercelAiSdkMachineString = (value: string): boolean => {
...
/** Creates one deeply immutable Vercel AI SDK evidence record. */
export const createVercelAiSdkEvidence = (
...
export const locateVercelAiSdkNode = (
