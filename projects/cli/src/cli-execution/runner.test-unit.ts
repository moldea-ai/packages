...
const INSTALLED_PACKAGE_METADATA = Object.freeze({
  dependencies: Object.freeze({
    '@moldea.ai/adapter-anthropic': 'workspace:^4.0.0',
    '@moldea.ai/adapter-claude-agent-sdk': 'workspace:^3.0.0',
    '@moldea.ai/adapter-cloudflare-agents': 'workspace:^3.0.0',
    '@moldea.ai/adapter-eve': 'workspace:^3.0.0',
    '@moldea.ai/adapter-google-genai': 'workspace:^3.0.0',
    '@moldea.ai/adapter-langchain': 'workspace:^3.0.0',
    '@moldea.ai/adapter-langgraph': 'workspace:^3.0.0',
    '@moldea.ai/adapter-openai': 'workspace:^4.0.0',
    '@moldea.ai/adapter-openai-agents-sdk': 'workspace:^3.0.0',
    '@moldea.ai/adapter-vercel-ai-sdk': 'workspace:^3.0.0',
...
`,
  ...
  test('returns the exact installed version without dispatching a command', async () => {
    ...
    ).resolves.toStrictEqual({ exitCode: 0, stderr: '', stdout: '8.0.0\n' });
    expect(executeCommand).not.toHaveBeenCalled();
  });
