...
/** Creates one strict schema 5 JSON envelope. */
...
/** Serializes one schema 5 envelope with its required trailing line feed. */
...
/** Measures the exact final UTF-8 bytes of one schema 5 JSON document. */
