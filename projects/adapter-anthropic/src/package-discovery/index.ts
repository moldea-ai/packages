...
import type { IAnthropicPackageDiscoveryResult } from '../contracts/index.js';
...
/**
 * Discovers the nearest relevant Anthropic package declaration without enumeration.
...
export const discoverAnthropicPackage = async (
  ...
  const result = await discoverPackage({
    ...
    sourcePath,
    supportedRange: ANTHROPIC_SDK_SUPPORTED_RANGE,
  });
