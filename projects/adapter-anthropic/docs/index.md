...
The package is available. Its technical target covers TypeScript ESM using direct Anthropic `messages.create`, `parse`, and `stream` calls with npm `@anthropic-ai/sdk >=0.117.1`, Repository Format version `1`, and compatible Core `^5.0.0`.
